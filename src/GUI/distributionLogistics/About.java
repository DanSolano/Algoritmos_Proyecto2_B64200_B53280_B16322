...
public class About extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Jesús Antonio Gutiérrez Matarrita (Full stack developer)");

        jLabel4.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 14)); // NOI18N
        jLabel4.setText("Michelle Mata Palma (Back-end developer)");

        jLabel5.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 14)); // NOI18N
        jLabel5.setText("Daniel Solano (Back-end developer)");

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/Images/logoMovistic.png"))); // NOI18N
